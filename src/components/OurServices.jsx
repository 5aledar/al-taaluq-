      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center animate__animated animate__fadeInUp">
        {features.map((feature, index) => (
          ...
          >
            ...
            <h5 className="text-xl text-pretty font-semibold mb-2 group-hover:text-orange-500 ">{feature.title}</h5>
            <p className="text-slate-600 text-lg text-balance overflow-y-auto  h-24 group-hover:text-slate-900">{feature.description}</p>
